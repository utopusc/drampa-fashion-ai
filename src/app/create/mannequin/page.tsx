    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-4">Create Mannequin Photos</h1>
          <p className="text-lg text-muted-foreground">
            Transform your mannequin products with AI-generated fashion models in 4 simple steps
          </p>
        </div>
...
const ProductUploadStep = ({ uploadedProducts, setUploadedProducts }: ProductUploadStepProps) => {
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-foreground mb-4">Upload Your Mannequin Product Images</h2>
        <p className="text-muted-foreground">
          Drag and drop your mannequin product images here, or click to browse
        </p>
...
// Model Selection Step Component (same as others)
...
// Background Selection Step Component (same as others)
...
// Summary Step Component (same as others)
...
export default MannequinCreate; 