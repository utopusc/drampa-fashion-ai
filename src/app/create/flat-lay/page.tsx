    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold text-foreground mb-4">Create Flat-Lay Photos</h1>
          <p className="text-lg text-muted-foreground">
            Transform your flat-lay products with AI-generated fashion models in 4 simple steps
          </p>
        </div>
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex space-x-4">
            {currentStep < steps.length - 1 ? (
              ...
              <button
                onClick={() => {
                  // Redirect to results page to show generation process
                  window.location.href = '/create/results';
                }}
                disabled={!canProceed()}
                className={`flex items-center space-x-2 px-8 py-3 rounded-lg transition-colors ${
                  canProceed()
...
const ProductUploadStep = ({ uploadedProducts, setUploadedProducts }: ProductUploadStepProps) => {
  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold text-foreground mb-4">Upload Your Flat-Lay Product Images</h2>
        <p className="text-muted-foreground">
          Drag and drop your flat-lay product images here, or click to browse
        </p>
...
// Model Selection Step Component (same as on-model)
...
// Background Selection Step Component (same as on-model)
...
const BackgroundSelectionStep = ({ selectedBackground, setSelectedBackground }: BackgroundSelectionStepProps) => {
  // All backgrounds from assets folder with actual filenames
  const backgrounds = [
...
// Summary Step Component (same as on-model)
