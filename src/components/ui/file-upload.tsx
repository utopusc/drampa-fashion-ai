                ...
                >
                  <div className="flex justify-between w-full items-center gap-4">
                    ...
                    <motion.p
                      ...
                      animate={{ opacity: 1 }}
                      layout
                      className="rounded-lg px-2 py-1 w-fit flex-shrink-0 text-sm text-muted-foreground bg-muted shadow-input"
                    >
...
export function GridPattern() {
  ...
  const rows = 11;
  return (
    <div className="flex bg-muted/30 dark:bg-muted/20 flex-shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px scale-105">
            ...
            <div
              ...
              className={`w-10 h-10 flex flex-shrink-0 rounded-[2px] ${
                index % 2 === 0
                  ...
                  : "bg-card dark:bg-card/80 shadow-[0px_0px_1px_3px_rgba(255,119,34,0.05)_inset] dark:shadow-[0px_0px_1px_3px_rgba(255,119,34,0.15)_inset]"
              }`}
            />
          );
        })
