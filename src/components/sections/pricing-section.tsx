      ...
      {["monthly", "yearly"].map((tab) => (
        ...
        >
          ...
          >
            ...
            {tab === "yearly" && (
              <span className="ml-2 text-xs font-semibold text-[#E65100] bg-[#FFF0E6] dark:bg-[#331400]/30 py-0.5 w-[calc(100%+1rem)] px-1 rounded-full">
                -20%
              </span>
            )}
          </span>
...
export function PricingSection() {
  ...
  return (
    <section
      id="pricing"
      className="flex flex-col items-center justify-center gap-10 py-20 w-full relative bg-gradient-to-t from-background to-[#FFF0E6]/30 dark:from-background dark:to-[#331400]/5"
    >
      <SectionHeader>
          ...
          {siteConfig.pricing.pricingItems.map((tier) => (
            <div
              ...
              className={cn(
                ...
                tier.isPopular
                  ? "md:shadow-[0px_61px_24px_-10px_rgba(0,0,0,0.01),0px_34px_20px_-8px_rgba(0,0,0,0.05),0px_15px_15px_-6px_rgba(0,0,0,0.09),0px_4px_8px_-2px_rgba(0,0,0,0.10),0px_0px_0px_1px_rgba(0,0,0,0.08)] bg-[#FFF0E6] dark:bg-[#331400]/10"
              ...
              <div className="p-4">
                {tier.name !== "Free" && (
                  <p className="text-sm mb-4">
                    Everything in {tier.name === "Designer" ? "Free" : "Designer"} +
                  </p>
                )}
                    ...
                    <li key={feature} className="flex items-center gap-2">
                      <div
                        className={cn(
                          ...
                          tier.isPopular &&
                            "bg-[#FFF0E6] border-[#FFCCAA] dark:bg-[#331400]/20 dark:border-[#FF7722]/30",
                        )}
                      >
                        <div className="size-3 flex items-center justify-center">
                          ...
                          >
                            <path
                              ...
                              stroke={tier.isPopular ? "#FF7722" : "#101828"}
                              strokeWidth="1.5"
                              strokeLinecap="round"
                          ...
                          >
                            <path
                              d="M1.5 3.48828L3.375 5.36328L6.5 0.988281"
                              stroke={tier.isPopular ? "#FF7722" : "white"}
                              strokeWidth="1.5"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                            />
